...
int main(int argc, char *argv[]) {
  ...
  if (read_incidence(&G,' ',IfileName)==-1){return log_error("function failed read_adjacency");}
  sprintf(msg,"read_incidence returned wrong number of edges. Edges is %ld it should be %d",get_no_e(&G),no_e);
